...
final class AiModelUsageLedgerSchema
{
    ...
    public static function postgresInstallStatements(): array
    {
        return [
            ...
            'ALTER TABLE ai_model_usage_events ADD CONSTRAINT ai_model_usage_attribution_valid '
    ...
    private static function sqliteInstallStatements(): array
    {
        ...
        $attribution = "((NEW.execution_scope = 'system' AND NEW.execution_admin_id IS NULL "
        ...
        return [
            'CREATE TRIGGER ai_model_usage_values_insert BEFORE INSERT ON ai_model_usage_events '
