...
final readonly class AdminAiSharingChangeResult
{
     ...
     * @param  array{title_generation_runs: int, article_ai_optimization_runs: int, knowledge_fact_generation_runs: int, ai_workspace_runs: int, total: int}  $pendingImpactCounts
     */
