# 2026-05-31 GEOFlow CLI 与 GUI 验收说明

本次提交把 GEOFlow 工程整理成可被外部程序调用的统一 CLI，并补齐正式链路在 GUI 中的可见状态。

## 本次新增能力

- 新增统一机器调用入口：`php artisan geoflow:cli <action> --json='{}' --pretty`
- 新增短包装脚本：`bin/geoflow-cli`
...
![GEOFlow GUI 草稿与公众号草稿状态](../screenshots/geoflow-cli-gui-draft-19.png)
...
- `docs/geo/screenshots/geoflow-cli-gui-draft-19.png`
