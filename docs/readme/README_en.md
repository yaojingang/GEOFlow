...
- **Default admin:** the production `init` container runs `db:seed` after migrations and creates the default account automatically. Credentials are listed in `../../docs/deployment/DEPLOYMENT.md`.
