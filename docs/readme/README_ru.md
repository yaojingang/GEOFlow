...
| 🌍 i18n админки | Китайский, английский, японский, испанский, русский и португальский (Бразилия) |
...
- **Учётная запись по умолчанию:** production-контейнер `init` запускает `db:seed` после миграций и автоматически создаёт стандартную учётную запись. Данные для входа указаны в **`../../docs/deployment/DEPLOYMENT.md`**.
